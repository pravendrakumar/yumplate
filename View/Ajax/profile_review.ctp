                            ...
                            <ul class="total-rates">
                                <li>
                                    ...
                                    <div class="rating-line pull-right">
                                      <?php $average=ceil(($profie_review['User']['reviews_avg_val_rating']+$profie_review['User']['reviews_avg_ontime_rating']+$profie_review['User']['reviews_avg_easyfind_rating'])/5);
                                      for($i=1;$i<=$average;$i++){
                                      echo '<span></span>';
                                    }
                                  ?>
