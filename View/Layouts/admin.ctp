...
<head>
   ...
   <?php echo $this->Html->script(array('jquery-1.11.2.min','jquery-1.11.2-ui.min','bootstrap', 'admin')); ?>
...
<body>
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <?php echo $this->Html->link($this->Html->image('/images/logo.gif'),'/admin',array('class'=>'navbar-brand','escape'=>false)); ?>
