...
<head>
    ...
    echo $this->Html->css(array('bootstrap.min.css', '//ajax.googleapis.com/ajax/libs/jqueryui/1.11.2/themes/smoothness/jquery-ui.css', 'admin.css')); ?>
...
<body>
    ...
    <div class="navbar navbar-inverse navbar-static-top" role="navigation">
        ...
        <?php echo $this->Html->link($this->Html->image('/images/logo.gif'),'/customer',array('class'=>'navbar-brand','escape'=>false)); ?>
        </div>
