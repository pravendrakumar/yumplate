...
<div class="main">
<input type="hidden" id="user_id_hdn" value="<?php echo $product['User']['id']?>">
...
<div class="firstInfo"  >
                    ...
                    <article>
                        ...
                        <ul>
                            ...
                            <li><i class="avrage-icon"></i><strong>Average review:</strong> 

                               <?php $average=ceil($product[0]['sum']/5);?>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="yamplate-review mr15 feedback-review">
                               ...
                               <a href="javascript:void(0)" class="readMore" id="addcoment" data-limit="" > read more comment</a>
                    ...
                    <div class="col-sm-6">
                        <div class="yamplate-review ml15" >
                            ...
                            <div class="chef-article">
                                ...
                                <a class="readMore" href="javascript:void(0)"> more</a></p>
                                <p class="more" style="display:none;">
                               <?php echo $product['User']['description'];?> <br/> <br/> 
                                <a class="readless" href="javascript:void(0)"> less</a></p>
                                <div class="social-icons social-tab">
                                    <ul>
                                     ...
                                     <?php 
                                     //echo $this->Html->image('/images/pinterest-128.png', array('alt' => 'pinterest','class'=>'img-responsive'));
                                     ?>
                                            </a-->

                                        <a href="https://www.pinterest.com/pin/create/button/
                                        ?url=<?php echo SITE_URL; ?>/yumplate/u/<?php echo $product['User']['first_name'];?>"
                                        ...
                                        <li>
                                            <a href="https://twitter.com/share/<?php echo SITE_URL; ?>/yumplate/u/<?php echo $product['User']['first_name'];?>" style="margin-top:0px !important;" class="twitter-share-button">Tweet</a>
                                        </li>
                                        
                                        <li>
                                          <div class="fb-send" style="float: left;padding-right: 30px;" data-href="<?php echo SITE_URL; ?>/yumplate/u/<?php echo $product['User']['first_name'];?>" data-font="arial"></div>
                                        </li>
                                    </ul>
                                </div>
                                <div class="clear"></div>
                            ...
                            <ul class="logistiecs">
                                ...
                                <li>
                                    <i class="parking-icon"></i>Parking......................................................... <span class="text-right1 uppercase"><?php echo !empty($product['User']['parking'])?$product['User']['parking']:'Not Assigned';?></span>
                                </li>
                                <li>
                                    <i class="delivery-icon"></i>
                                    Delivery.......................................................................... <span class="text-right1 uppercase"><?php echo !empty($product['User']['delivery'])?$product['User']['delivery']:'Not Assigned';?></span>
                                </li>
                            </ul>
                        </div>  
                    </div>
