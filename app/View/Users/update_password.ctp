      ...
      <div class="modal-body">
        <!--div class="form-group">
          ...
          <div class="form-group">
            ...
            <?php echo $this->Form->input('password',array('type'=>'password','placeholder'=>'Enter new password ','div'=>false,'label'=>false,'class'=>'form-control','required'=>true));?>
           
          </div>
           <div class="form-group">
            <label for="recipient-name" class="control-label">Confirm password:</label>
            <?php echo $this->Form->input('cpassword',array('type'=>'password','placeholder'=>'Connfirm password','div'=>false,'label'=>false,'class'=>'form-control','required'=>true));?>
