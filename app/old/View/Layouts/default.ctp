...
<head>
  ...
  <?php 
    ...
    echo $this->Html->css(array('bootstrap.min', 'jquery-ui', 'admin')); 
     echo $this->Html->script(array('jquery-1.11.2.min','jquery-1.11.2-ui.min','bootstrap.min', 'admin','yumplate')); 
    ...
    <div class="navbar navbar-inverse navbar-static-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
               ...
               <?php echo $this->Html->link($this->Html->image('/images/YumPlate-Beta.png'),'/products',array('class'=>'navbar-brand','escape'=>false)); ?>
            </div>
