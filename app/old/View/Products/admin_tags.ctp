...
<?php echo $this->Html->link('Edit Recipe', array('action' => 'edit', $product['Product']['id']), array('class' => 'btn btn-default')); ?>
...
<table class="table-striped table-bordered table-condensed table-hover">
    <tr>
        ...
        <td valign="top">
            ...
            <br />
            <br />
            <?php echo $this->Html->link('Edit Previous Tags', array('action' => 'tags', $neighbors['prev']['Product']['id']), array('class' => 'btn btn-default btn-sm')); ?>
        </td>
        <td valign="top">
        &nbsp; &nbsp;
        </td>
        ...
        <td valign="top">
            ...
            <br />
            <br />
            <?php echo $this->Html->link('Edit Next Tags', array('action' => 'tags', $neighbors['next']['Product']['id']), array('class' => 'btn btn-default btn-sm')); ?>
        </td>
    </tr>
</table>
